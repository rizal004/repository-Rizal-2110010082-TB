...
public String tgl_lahir;
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Pendaftran Siswa ", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 18))); // NOI18N
        ...
        jLabel7.setText("Table Pendaftaran Siswa");
        ...
        jurusan.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Ekonomi", "Teknik Informatika", "Fisika " }));
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(telpon, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE))
                                ...
                                .addGap(32, 32, 32)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jurusan, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(tgl, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)))))
    ...
    private void bt_simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_simpanActionPerformed
      try{
          String sql = "insert into tbpendaftaran values('"//simpan data pada tabel 'tbpendaftaran'
                  +npm.getText()+"','"
                  +nama.getText()+"','"
          ...
          java.sql.PreparedStatement pst = conn.prepareStatement(sql);// Membuat objek PreparedStatement untuk mengeksekusi pernyataan SQL
                pst.execute();
                JOptionPane.showMessageDialog(null, "Terima Kasih Mendaftar");// Menampilkan pesan bahwa data berhasil disimpan
    ...
    private void tb_editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tb_editActionPerformed
        try{
            ...
            String sql = "update tbpendaftaran set nama='" + nama.getText()+//melakukan update data pada tabel 'tbpendaftaran' 
    ...
    private void tb_hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tb_hapusActionPerformed
        try{
    java.sql.Connection conn=(java.sql.Connection)project.Koneksi.koneksiDB();
    String sql = "delete from tbpendaftaran where npm='"+npm.getText()+"' ";// Membuat pernyataan untuk menghapus data berdasarkan nilai dari komponen 'no'
    java.sql.PreparedStatement pst = conn.prepareStatement(sql);
    ...
    private void bt_cariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_cariActionPerformed
       try {
    java.sql.Connection conn=(java.sql.Connection)project.Koneksi.koneksiDB();
    String sql = "Select * from tbpendaftaran where npm='"+cari.getText()+"' or nama='"+cari.getText()+"'";
    java.sql.PreparedStatement pst = conn.prepareStatement(sql);
    ...
    if (rs.next()){
        ...
        telpon.setText(rs.getString(7));
        jurusan.setSelectedItem(rs.getString(8));
        JOptionPane.showMessageDialog(null,"Data tbpendaftaran : "
...
cari.requestFocus();
    ...
    public void tampil_data(){
        ...
        tabel.addColumn("NPM");// Menambahkan kolom-kolom yang akan ditampilkan dalam tabel
